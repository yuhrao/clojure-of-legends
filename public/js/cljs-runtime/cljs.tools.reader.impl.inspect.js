...
cljs.tools.reader.impl.inspect.inspect_STAR__col = (function cljs$tools$reader$impl$inspect$inspect_STAR__col(truncate,col__$1,start,end){
var n = cljs.core.count(col__$1);
var l = (cljs.core.truth_(truncate)?(0):(function (){var x__5133__auto__ = (10);
var y__5134__auto__ = n;
return ((x__5133__auto__ < y__5134__auto__) ? x__5133__auto__ : y__5134__auto__);
})());
var elements = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.impl.inspect.inspect_STAR_,true),cljs.core.take.cljs$core$IFn$_invoke$arity$2(l,col__$1));
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26501 = cljs.core.get_global_hierarchy;
return (fexpr__26501.cljs$core$IFn$_invoke$arity$0 ? fexpr__26501.cljs$core$IFn$_invoke$arity$0() : fexpr__26501.call(null));
})());
...
cljs.tools.reader.impl.inspect.inspect_STAR_.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"list","list",765357683),(function (truncate,col__$1){
return cljs.tools.reader.impl.inspect.inspect_STAR__col(truncate,col__$1,"(",")");
}));
...
cljs.tools.reader.impl.inspect.inspect_STAR_.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"set","set",304602554),(function (truncate,col__$1){
return cljs.tools.reader.impl.inspect.inspect_STAR__col(truncate,col__$1,"#{","}");
}));
cljs.tools.reader.impl.inspect.inspect_STAR_.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"vector","vector",1902966158),(function (truncate,col__$1){
return cljs.tools.reader.impl.inspect.inspect_STAR__col(truncate,col__$1,"[","]");
}));
