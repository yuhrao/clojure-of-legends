...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26671 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26671(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26680 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26680(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26685 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26685(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26691 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26691(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26695 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26695(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26698 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26698(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26700 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26700(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26709 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26709(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26715 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26715(b);
}
});
...
var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26721 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26721(b);
}
});
