...
var i_29367 = (self__.level + (1));
while(true){
if((i_29367 <= (new_level + (1)))){
(update[i_29367] = self__.header);

var G__29368 = (i_29367 + (1));
i_29367 = G__29368;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29373 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29373[i]));
} else {
x__$2.forward.push((((i < links_29373.length))?(links_29373[i]):null));
}

if((i < links_29373.length)){
(links_29373[i] = x__$2);
} else {
links_29373.push(x__$2);
}
...
var i_29393 = (0);
while(true){
if((i_29393 <= self__.level)){
var links_29394 = (update[i_29393]).forward;
if((x__$1 === (((i_29393 < links_29394.length))?(links_29394[i_29393]):null))){
(links_29394[i_29393] = (x__$1.forward[i_29393]));

var G__29396 = (i_29393 + (1));
i_29393 = G__29396;
continue;
} else {
var G__29397 = (i_29393 + (1));
i_29393 = G__29397;
continue;
}
} else {
...
var G__29405 = nx;
var G__29406 = (level__$1 - (1));
x = G__29405;
level__$1 = G__29406;
continue;
} else {
var G__29407 = x;
var G__29408 = (level__$1 - (1));
x = G__29407;
level__$1 = G__29408;
continue;
}
