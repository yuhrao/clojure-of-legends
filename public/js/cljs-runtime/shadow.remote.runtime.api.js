...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29657 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29657(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29658 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29658(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29669 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29669(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29677 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29677(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29693 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29693(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29695 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29695(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29637,callback){
var map__29639 = p__29637;
var map__29639__$1 = cljs.core.__destructure_map(map__29639);
var input = map__29639__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29639__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29639__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
