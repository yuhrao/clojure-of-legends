...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"f","f",43394975,null),new cljs.core.Symbol(null,"meta29089","meta29089",1131679181,null)], null);
}));
...
(cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29088.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers29088");
}));
...
var fexpr__29125 = cljs.core.async.impl.ioc_helpers.aget_object(state,(0));
return (fexpr__29125.cljs$core$IFn$_invoke$arity$1 ? fexpr__29125.cljs$core$IFn$_invoke$arity$1(state) : fexpr__29125.call(null,state));
});
...
var statearr_29136_29163 = state;
(statearr_29136_29163[(2)] = x);

(statearr_29136_29163[(1)] = blk);
...
var statearr_29138_29167 = state;
(statearr_29138_29167[(2)] = cljs.core.deref(cb));

(statearr_29138_29167[(1)] = blk);
...
var statearr_29144_29171 = state;
(statearr_29144_29171[(2)] = ret_val);

(statearr_29144_29171[(1)] = blk);
...
if(cljs.core.truth_(temp__5802__auto__)){
var cb = temp__5802__auto__;
var statearr_29145_29173 = state;
(statearr_29145_29173[(2)] = cljs.core.deref(cb));

(statearr_29145_29173[(1)] = blk);
