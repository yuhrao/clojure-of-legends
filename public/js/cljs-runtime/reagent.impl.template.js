...
var G__38685 = o;
reagent.impl.template.goog$module$goog$object.set(G__38685,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38753__delegate = function (args){
...
while (G__38754__i < G__38754__a.length) {G__38754__a[G__38754__i] = arguments[G__38754__i + 0]; ++G__38754__i;}
  args = new cljs.core.IndexedSeq(G__38754__a,0,null);
} 
return G__38753__delegate.call(this,args);};
G__38753.cljs$lang$maxFixedArity = 0;
G__38753.cljs$lang$applyTo = (function (arglist__38755){
var args = cljs.core.seq(arglist__38755);
return G__38753__delegate(args);
});
...
var G__38688 = o;
reagent.impl.template.goog$module$goog$object.set(G__38688,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38756__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__38756__delegate.call(this,args);};
...
return G__38756__delegate(args);
});
...
var G__38693 = props;
var G__38693__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38693,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38693);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38693__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38698 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38698,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38698;
}
})(),id_class);
...
var G__38700 = (cljs.core.count(argv) - first_child);
switch (G__38700) {
case (0):
...
var vec__38708 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38708,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38708,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38708,(2),null);
...
var temp__5808__auto___38770 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___38770 == null)){
} else {
var key_38771 = temp__5808__auto___38770;
(jsprops.key = key_38771);
}
...
var temp__5808__auto___38773 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___38773 == null)){
} else {
var key_38775 = temp__5808__auto___38773;
(jsprops.key = key_38775);
}
...
var temp__5808__auto___38776 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___38776 == null)){
} else {
var key_38777 = temp__5808__auto___38776;
(jsprops.key = key_38777);
}
...
var temp__5808__auto___38782 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___38782 == null)){
} else {
var key_38784 = temp__5808__auto___38782;
(jsprops.key = key_38784);
}
...
var temp__5808__auto___38785 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___38785 == null)){
} else {
var key_38786 = temp__5808__auto___38785;
(jsprops.key = key_38786);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38724_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38724_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38727 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38727,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38727,(1),null);
...
break;
default:
var G__38795 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38796 = compiler;
v = G__38795;
compiler = G__38796;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38740 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38740 = (function (opts,id,fn_to_element,parse_fn,meta38741){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38740.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38742,meta38741__$1){
var self__ = this;
var _38742__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38740(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38741__$1));
}));

(reagent.impl.template.t_reagent$impl$template38740.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38742){
var self__ = this;
var _38742__$1 = this;
return self__.meta38741;
}));

(reagent.impl.template.t_reagent$impl$template38740.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38740.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38740.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38740.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38740.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38740.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38741","meta38741",-1189570163,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38740.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38740.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38740");

(reagent.impl.template.t_reagent$impl$template38740.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template38740");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38740.
 */
reagent.impl.template.__GT_t_reagent$impl$template38740 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38740(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38741){
return (new reagent.impl.template.t_reagent$impl$template38740(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38741));
});

}

return (new reagent.impl.template.t_reagent$impl$template38740(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
